  ...
  >
    ...
    <slot>
      ...
      >
        <h6 v-text="title" />
        <p
          class="timeline-item-time text-nowrap text-muted font-small-3"
          v-text="time"
        />
      </div>
...
@import '@/assets/scss/template/base/bootstrap-extended/include';
@import '@/assets/scss/template/base/components/include';

@import '@/assets/scss/template/base/core/colors/palette-variables.scss';
